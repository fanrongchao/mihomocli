...
- Runtime assets (`Country.mmdb`, `geoip.dat`, `geosite.dat`) are downloaded automatically to `~/.config/mihomocli/resources/` when the CLI runs; keep this directory documented if relocating assets.
