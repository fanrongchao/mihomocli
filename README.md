...
- `--dev-rules [--dev-rules-via <NAME>]`: Prepend proxy rules for common developer registries (GitHub/GitLab, Go proxy, npm/yarn/pnpm, PyPI, crates.io, Kubernetes registries, Docker/GCR, cache.nixos.org, etc.). Defaults to routing via `Proxy`.
