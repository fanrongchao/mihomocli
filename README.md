...
- `--dev-rules [--dev-rules-via <NAME>]`: Prepend proxy rules for common developer registries (GitHub, GitLab, Go proxy, npm, PyPI, crates.io, Maven, Docker/GCR, cache.nixos.org, etc.). Defaults to routing via `Proxy`.
